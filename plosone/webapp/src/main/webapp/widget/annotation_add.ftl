<div dojoType="topaz:regionalDialog" id="AnnotationDialog" bgColor="#333333" bgOpacity="0.6" toggle="fade" toggleDuration="250" closeOnBackgroundClick="false" style="padding:0;margin:0;">
	<div class="dialog annotate">
		...
		<div class="comment">
			<h5><span class="commentPrivate">Add Your Comment (For Private Viewing)</span><span class="commentPublic">Post Your Comment (For Public Viewing)</span></h5>
			<div class="posting pane">
				<form name="createAnnotation" id="createAnnotation" method="post" action="">
					...
					<fieldset>
						...
						-->
						<div class="btnwrap commentPrivate"><input type="button" value="Save" class="commentPrivate" title="Click to save your comment privately" id="btn_save"/></div>
						<div class="btnwrap commentPublic"><input type="button" value="Post" class="commentPublic" title="Click to post your comment publicly" id="btn_post"/></div>
					</fieldset>
				</form>
			</div>
		</div>
