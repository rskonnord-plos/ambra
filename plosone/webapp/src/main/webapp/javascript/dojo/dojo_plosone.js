...
this.scriptScope;
this.bindArgs={};
},{isContainer:true,adjustPaths:true,href:"",extractContent:true,parseContent:true,cacheContent:true,preload:false,refreshOnShow:false,handler:"",executeScripts:false,scriptSeparation:true,loadingMessage:"Loading...",isLoaded:false,postCreate:function(args,frag,_814){
if(this.handler!==""){
...
},_downloadExternalContent:function(url,_818){
this.abort();
...
},_cacheSetting:function(_81e,_81f){
for(var x in this.bindArgs){
if(dojo.lang.isUndefined(_81e[x])){
_81e[x]=this.bindArgs[x];
}
}
if(dojo.lang.isUndefined(_81e.useCache)){
_81e.useCache=_81f;
}
if(dojo.lang.isUndefined(_81e.preventCache)){
_81e.preventCache=!_81f;
}
if(dojo.lang.isUndefined(_81e.mimetype)){
_81e.mimetype="text/html";
}
return _81e;
},onLoad:function(e){
...
},_runStack:function(_824){
var st=this[_824];
var err="";
var _827=this.scriptScope||window;
...
this[_824]=[];
if(err.length){
var name=(_824=="_onLoadStack")?"addOnLoad":"addOnUnLoad";
...
},_pushOnStack:function(_82e,obj,func){
...
},_handleDefaults:function(e,_838,_839){
if(!_838){
_838="onContentError";
}
...
var _83c=[],_83d=[],tmp=[];
var _83f=[],_840=[],attr=[],_842=[];
var str="",path="",fix="",_846="",tag="",_848="";
if(!url){
url="./";
}
if(s){
var _849=/<title[^>]*>([\s\S]*?)<\/title>/i;
while(_83f=_849.exec(s)){
_83c.push(_83f[1]);
s=s.substring(0,_83f.index)+s.substr(_83f.index+_83f[0].length);
}
if(this.adjustPaths){
var _84a=/<[a-z][a-z0-9]*[^>]*\s(?:(?:src|href|style)=[^>])+[^>]*>/i;
var _84b=/\s(src|href|style)=(['"]?)([\w()\[\]\/.,\\'"-:;#=&?\s@]+?)\2/i;
var _84c=/^(?:[#]|(?:(?:https?|ftps?|file|javascript|mailto|news):))/;
while(tag=_84a.exec(s)){
str+=s.substring(0,tag.index);
s=s.substring((tag.index+tag[0].length),s.length);
tag=tag[0];
_846="";
while(attr=_84b.exec(tag)){
path="";
_848=attr[3];
...
path=(new dojo.uri.Uri(url,_848).toString());
}
break;
case "style":
path=dojo.html.fixPathsInCssText(_848,url);
break;
default:
path=_848;
}
fix=" "+attr[1]+"="+attr[2]+path+attr[2];
_846+=tag.substring(0,attr.index)+fix;
...
_849=/(?:<(style)[^>]*>([\s\S]*?)<\/style>|<link ([^>]*rel=['"]?stylesheet['"]?[^>]*)>)/i;
while(_83f=_849.exec(s)){
if(_83f[1]&&_83f[1].toLowerCase()=="style"){
_842.push(dojo.html.fixPathsInCssText(_83f[2],url));
}else{
if(attr=_83f[3].match(/href=(['"]?)([^'">]*)\1/i)){
_842.push({path:attr[2]});
}
}
s=s.substring(0,_83f.index)+s.substr(_83f.index+_83f[0].length);
}
var _849=/<script([^>]*)>([\s\S]*?)<\/script>/i;
var _84d=/src=(['"]?)([^"']*)\1/i;
var _84e=/.*(\bdojo\b\.js(?:\.uncompressed\.js)?)$/;
var _84f=/(?:var )?\bdjConfig\b(?:[\s]*=[\s]*\{[^}]+\}|\.[\w]*[\s]*=[\s]*[^;\n]*)?;?|dojo\.hostenv\.writeIncludes\(\s*\);?/g;
var _850=/dojo\.(?:(?:require(?:After)?(?:If)?)|(?:widget\.(?:manager\.)?registerWidgetPackage)|(?:(?:hostenv\.)?setModulePrefix|registerModulePath)|defineNamespace)\((['"]).*?\1\)\s*;?/;
while(_83f=_849.exec(s)){
if(this.executeScripts&&_83f[1]){
if(attr=_84d.exec(_83f[1])){
if(_84e.exec(attr[2])){
dojo.debug("Security note! inhibit:"+attr[2]+" from  being loaded again.");
}else{
_83d.push({path:attr[2]});
}
}
}
if(_83f[2]){
var sc=_83f[2].replace(_84f,"");
if(!sc){
continue;
}
while(tmp=_850.exec(sc)){
_840.push(tmp[0]);
...
s=s.substr(0,_83f.index)+s.substr(_83f.index+_83f[0].length);
}
if(this.extractContent){
_83f=s.match(/<body[^>]*>\s*([\s\S]+)\s*<\/body>/im);
if(_83f){
s=_83f[1];
}
}
if(this.executeScripts&&this.scriptSeparation){
var _849=/(<[a-zA-Z][a-zA-Z0-9]*\s[^>]*?\S=)((['"])[^>]*scriptScope[^>]*>)/;
var _852=/([\s'";:\(])scriptScope(.*)/;
str="";
while(tag=_849.exec(s)){
tmp=((tag[3]=="'")?"\"":"'");
fix="";
str+=s.substring(0,tag.index)+tag[1];
while(attr=_852.exec(tag[2])){
...
return {"xml":s,"styles":_842,"titles":_83c,"requires":_840,"scripts":_83d,"url":url};
...
var _858=this;
function asyncParse(){
if(_858.executeScripts){
_858._executeScripts(data.scripts);
}
if(_858.parseContent){
var node=_858.containerNode||_858.domNode;
var _85a=new dojo.xml.Parse();
var frag=_85a.parseElement(node,null,true);
dojo.widget.getParser().createSubComponents(frag,_858);
}
_858.onResized();
_858.onLoad();
}
...
},setHandler:function(_85c){
var fcn=dojo.lang.isFunction(_85c)?_85c:window[_85c];
if(!dojo.lang.isFunction(fcn)){
this._handleDefaults("Unable to set handler, '"+_85c+"' not a function.","onExecError",true);
return;
}
...
this.onLoad();
return ret;
},_executeScripts:function(_85f){
var self=this;
var tmp="",code="";
for(var i=0;i<_85f.length;i++){
if(_85f[i].path){
dojo.io.bind(this._cacheSetting({"url":_85f[i].path,"load":function(type,_865){
dojo.lang.hitch(self,tmp=";"+_865);
},"error":function(type,_867){
_867.text=type+" downloading remote script";
self._handleDefaults.call(self,_867,"onExecError","debug");
...
dojo.html.iframeContentWindow=function(_86b){
var win=dojo.html.getDocumentWindow(dojo.html.iframeContentDocument(_86b))||dojo.html.iframeContentDocument(_86b).__parent__||(_86b.name&&document.frames[_86b.name])||null;
return win;
};
dojo.html.iframeContentDocument=function(_86d){
var doc=_86d.contentDocument||((_86d.contentWindow)&&(_86d.contentWindow.document))||((_86d.name)&&(document.frames[_86d.name])&&(document.frames[_86d.name].document))||null;
return doc;
};
...
var _871=dojo.html.getMarginBox(this.domNode);
if(_871.width==0||_871.height==0){
dojo.lang.setTimeout(this,this.onResized,100);
return;
}
this.iframe.style.width=_871.width+"px";
this.iframe.style.height=_871.height+"px";
}
},size:function(node){
if(!this.iframe){
return;
}
var _873=dojo.html.toCoordinateObject(node,true,dojo.html.boxSizing.BORDER_BOX);
this.iframe.style.width=_873.width+"px";
this.iframe.style.height=_873.height+"px";
this.iframe.style.left=_873.left+"px";
this.iframe.style.top=_873.top+"px";
...
},setBackgroundColor:function(_879){
if(arguments.length>=3){
_879=new dojo.gfx.color.Color(arguments[0],arguments[1],arguments[2]);
}else{
_879=new dojo.gfx.color.Color(_879);
}
this.shared.bg.style.backgroundColor=_879.toString();
return this.bgColor=_879;
...
if(this.bgOpacity>0){
var _87b=dojo.html.getViewport();
var h=_87b.height;
var w=_87b.width;
with(this.shared.bg.style){
width=w+"px";
...
this.shared.bg.style.top=_87e.y+"px";
this.shared.bg.style.left=_87e.x+"px";
var _87b=dojo.html.getViewport();
if(_87b.width!=w){
this.shared.bg.style.width=_87b.width+"px";
}
if(_87b.height!=h){
this.shared.bg.style.height=_87b.height+"px";
}
}
...
var _880=dojo.html.getViewport();
var mb=dojo.html.getMarginBox(this.containerNode);
var x=_87f.x+(_880.width-mb.width)/2;
var y=_87f.y+(_880.height-mb.height)/2;
with(this.domNode.style){
left=x+"px";
top=y+"px";
}
...
var _884=dojo.html.getScroll().offset;
this.shared.bg.style.top=_884.y+"px";
this.shared.bg.style.left=_884.x+"px";
...
dojo.declare("dojo.widget.RegionalDialogBase",[dojo.widget.DialogBase],{isContainer:true,shared:{bg:null,bgIframe:null,onClickCatcher:null},focusElement:"",bgColor:"black",bgOpacity:0.4,followScroll:true,markerNode:null,tipDownNode:null,tipUpNode:null,activeNode:null,templateString:"\n<div id=\"${this.widgetId}\" class=\"dojoDialog\" dojoattachpoint=\"wrapper\">\n	<span dojoattachpoint=\"tabStartOuter\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\"	tabindex=\"0\"></span>\n	<span dojoattachpoint=\"tabStart\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n	<div dojoattachpoint=\"containerNode\" style=\"position: relative; z-index: 2;\"></div>\n	<span dojoattachpoint=\"tabEnd\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n	<span dojoattachpoint=\"tabEndOuter\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n</div>\n",closeOnBackgroundClick:true,trapTabs:function(e){
if(e.target==this.tabStartOuter){
if(this._fromTrap){
this.tabStart.focus();
this._fromTrap=false;
...
var _88c=this.shared.bgIframe.iframe?this.shared.bgIframe.iframe.contentWindow.document:this.shared.bg;
dojo.event.kwConnect({srcObj:_88c,srcFunc:"onclick",adviceObj:this,adviceFunc:"onBackgroundClick",once:true});
}
}
},setBackgroundColor:function(_88d){
if(arguments.length>=3){
_88d=new dojo.gfx.color.Color(arguments[0],arguments[1],arguments[2]);
}else{
_88d=new dojo.gfx.color.Color(_88d);
}
this.shared.bg.style.backgroundColor=_88d.toString();
return this.bgColor=_88d;
},setBackgroundOpacity:function(op){
if(arguments.length==0){
op=this.bgOpacity;
}
...
if(this.bgOpacity>0){
var _88f=dojo.html.getViewport();
var h=_88f.height;
var w=_88f.width;
with(this.shared.bg.style){
width=w+"px";
...
var _892=dojo.html.getScroll().offset;
this.shared.bg.style.top=_892.y+"px";
this.shared.bg.style.left=_892.x+"px";
var _88f=dojo.html.getViewport();
if(_88f.width!=w){
this.shared.bg.style.width=_88f.width+"px";
}
if(_88f.height!=h){
this.shared.bg.style.height=_88f.height+"px";
}
}
},_showBackground:function(){
if(this.bgOpacity>0){
...
},_changeTipDirection:function(_893,_894){
var dTip=this.tipDownNode;
var _896=this.tipUpNode;
dTip.className=dTip.className.replace(/\son/,"");
_896.className=_896.className.replace(/\son/,"");
var _897=(_893)?dTip:_896;
_897.className=_897.className.concat(" on");
_897.style.left=(_894)?_894+"px":"auto";
},placeModalDialog:function(){
var _898=dojo.html.getScroll().offset;
var _899=dojo.html.getViewport();
var _89a=this.markerNode;
var _89b=topaz.domUtil.getCurrentOffset(_89a);
var mb=dojo.html.getMarginBox(this.containerNode);
var _89d=mb.width;
var _89e=mb.height;
var _89f=_899.width;
var _8a0=_899.height;
var _8a1=_898.x;
var _8a2=_898.y;
var _8a3=22;
var _8a4=39;
...
var xMin=_8a1+_8a7;
var yMin=_8a2+_8a8;
var xMax=_8a1+_89f-_8a7-_89d;
var yMax=_8a2+_8a0-_8a8-_89e;
var _8ae=xMin+_8a5;
var _8af=xMax+_89d-_8a6-_8a4;
var _8b0=true;
if(xMin>xMax||yMin>yMax||_8ae>_8af){
}
var xTip=_89b.left-(_8a4/2);
var yTip=_89b.top-_8a3-(_8a3/4);
var x=xTip-_8a5;
var y=yTip-_89e;
if(x<xMin){
x=xMin;
...
if(y<yMin){
_8b0=false;
yTip=_89b.top+_8a9-(_8a3/4);
y=yTip+_8a3;
if(y>yMax){
}
}
var _8b5=_89b.left-x;
if(_8b5<_8a5){
xTipPos=_8a5-(_8a4/4);
x=x-(_8a5-_8b5);
}else{
...
this._changeTipDirection(_8b0,xTipPos);
with(this.domNode.style){
left=x+"px";
top=y+"px";
}
...
var _8b6=dojo.html.getScroll().offset;
this.shared.bg.style.top=_8b6.y+"px";
this.shared.bg.style.left=_8b6.x+"px";
this.placeModalDialog();
},checkSize:function(){
if(this.isShowing()){
this._sizeBackground();
...
dojo.widget.defineWidget("dojo.widget.RegionalDialog",[dojo.widget.ContentPane,dojo.widget.RegionalDialogBase],{templateString:"<div id=\"${this.widgetId}\" class=\"dojoDialog\" dojoattachpoint=\"wrapper\">\n	<span dojoattachpoint=\"tabStartOuter\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\"	tabindex=\"0\"></span>\n	<span dojoattachpoint=\"tabStart\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n	<div dojoattachpoint=\"containerNode\" style=\"position: relative; z-index: 2;\"></div>\n	<span dojoattachpoint=\"tabEnd\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n	<span dojoattachpoint=\"tabEndOuter\" dojoonfocus=\"trapTabs\" dojoonblur=\"clearTrap\" tabindex=\"0\"></span>\n</div>\n",blockDuration:0,lifetime:0,closeNode:"",postMixInProperties:function(){
...
dojo.AdapterRegistry=function(_8bd){
this.pairs=[];
this.returnWrappers=_8bd||false;
};
dojo.lang.extend(dojo.AdapterRegistry,{register:function(name,_8bf,wrap,_8c1,_8c2){
var type=(_8c2)?"unshift":"push";
this.pairs[type]([name,_8bf,wrap,_8c1]);
},match:function(){
...
dojo.json={jsonRegistry:new dojo.AdapterRegistry(),register:function(name,_8ca,wrap,_8cc){
dojo.json.jsonRegistry.register(name,_8ca,wrap,_8cc);
...
if(_8cf!="function"&&typeof (o.length)=="number"){
var res=[];
...
try{
window.o=o;
_8d1=dojo.json.jsonRegistry.match(o);
return me(_8d1);
}
catch(e){
}
...
if(typeof (k)=="string"){
_8d6=dojo.string.escapeString(k);
}else{
continue;
}
}
