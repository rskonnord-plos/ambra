...
import static org.plos.user.UsersPEP.FIND_USERS_BY_PROF;
import static org.plos.user.UsersPEP.GET_BIOGRAPHY;
import static org.plos.user.UsersPEP.GET_BIOGRAPHY_TEXT;
import static org.plos.user.UsersPEP.GET_CITY;
import static org.plos.user.UsersPEP.GET_COUNTRY;
import static org.plos.user.UsersPEP.GET_DISP_NAME;
import static org.plos.user.UsersPEP.GET_EMAIL;
import static org.plos.user.UsersPEP.GET_GENDER;
import static org.plos.user.UsersPEP.GET_GIVEN_NAMES;
import static org.plos.user.UsersPEP.GET_HOME_PAGE;
import static org.plos.user.UsersPEP.GET_INTERESTS;
import static org.plos.user.UsersPEP.GET_INTERESTS_TEXT;
import static org.plos.user.UsersPEP.GET_ORGANIZATION_NAME;
import static org.plos.user.UsersPEP.GET_ORGANIZATION_TYPE;
import static org.plos.user.UsersPEP.GET_POSITION_TYPE;
import static org.plos.user.UsersPEP.GET_POSTAL_ADDRESS;
import static org.plos.user.UsersPEP.GET_PUBLICATIONS;
import static org.plos.user.UsersPEP.GET_REAL_NAME;
import static org.plos.user.UsersPEP.GET_RESEARCH_AREAS_TEXT;
import static org.plos.user.UsersPEP.GET_SURNAMES;
import static org.plos.user.UsersPEP.GET_TITLE;
import static org.plos.user.UsersPEP.GET_WEBLOG;
import static org.plos.user.UsersPEP.SET_PROFILE;
