...
<div class="intro">
<p><em>PLoS ONE</em> (eISSN-1932-6203) is an international, peer-reviewed, open-access, online publication. <em>PLoS ONE</em> welcomes reports on primary research from any scientific discipline. It provides:
  <ul>
    <li>Open-access - freely accessible online, authors retain copyright</li>
    <li>Fast publication - acceptance to publication in an average of 14 working days</li>
