 ...
 * agreements. The ASF licenses this file to You under the Apache License, Version 2.0 (the
 ...
 * the License. For additional information regarding copyright in this work, please see the NOTICE
...
public class Utilities {
  ...
  public static int[] stringToIntArray(String instr, String delim) throws NoSuchElementException,
  ...
  public static void copyFile(File from, File to) throws IOException {
    ...
    try {
      ...
      throw new IOException("Utilities.copyFile: opening input stream '" + from.getPath() + "', "
          + ex.getMessage());
    }
    ...
    try {
      ...
      throw new IOException("Utilities.copyFile: opening output stream '" + to.getPath() + "', "
          + ex.getMessage());
    }
   ...
   * Ensures right numbers of bytes copied.
   */
   ...
   */
  /*
   * public static String encodeString(String str) throws IOException { BASE64Encoder encoder = new
   * BASE64Encoder(); String encodedStr = encoder.encodeBuffer(str.getBytes());
   * 
   ...
   */
  /*
   * public static String decodeString(String str) throws IOException { BASE64Decoder dec = new
   * BASE64Decoder(); String value = new String(dec.decodeBuffer(str));
   * 
   * return (value); }
   */
   ...
   * Copyright (c) 1999 The Apache Software Foundation. Author: timster@mac.com
   * 
   * @param str
   * @param lower
   * @param upper
  ...
  /**
   * Need need to get rid of any user-visible HTML tags once all text has been removed such as
   * &lt;BR&gt;. This sounds like a better approach than removing all HTML tags and taking the
   * chance to leave some tags un-closed.
   * 
  ...
  /*
   * public static String hexEncode(String str) { if (StringUtils.isEmpty(str)) return str;
   * 
   * return RegexUtil.encode(str); }
   * 
   * public static String encodeEmail(String str) { return str!=null ? RegexUtil.encodeEmail(str) :
   * null; }
   */
