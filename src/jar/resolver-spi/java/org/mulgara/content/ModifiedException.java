...
/**
 * Exception thrown by the {@link Content#newOutputStream} method to
 * indicate that the source of content has changed from the cached version, and
 * that writing to it would cause that update to be lost.
 *
 * @created 2004-12-02
 *
...
{
  /**
   * The URI of the modified content.
   */
   ...
   * Sole constructor.
   *
   * @param uri  the URI of the modified content, never <code>null</code>
