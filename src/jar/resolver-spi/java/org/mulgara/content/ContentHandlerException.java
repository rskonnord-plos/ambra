...
/**
 * Exception thrown when a content handler encounters an exception.
 *
 * @created 2004-09-21
 *
 * @author Mark Ludlow
...
public class ContentHandlerException extends Exception {
   ...
   */
  public ContentHandlerException(String s) {
    ...
    */
  public ContentHandlerException(String s, Exception e) {
