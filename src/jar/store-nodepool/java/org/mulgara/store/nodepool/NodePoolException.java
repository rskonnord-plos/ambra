...
public class NodePoolException extends StoreException {
  ...
  /**
   * CONSTRUCTOR NodePoolException TO DO
   *
   ...
   */
  public NodePoolException(String message, Throwable throwable) {
   ...
   * @param throwable PARAMETER TO DO
   */
  public NodePoolException(Throwable throwable) {
    super(throwable);
  }
}
