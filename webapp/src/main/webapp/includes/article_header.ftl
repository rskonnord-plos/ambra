<#--
  $HeadURL: http://svn.ambraproject.org/svn/plos/templates/head/journals/PLoSDefault/webapp/includes/article_header.ftl $
  $Id: article_header.ftl 13533 2013-01-25 03:01:35Z mbaehr $
...
<div class="article-meta cf">
  <ul id="almSignPost" style="display: none;">
  </ul>
...
<#include "article_header_kicker.ftl" />
  ...
  <@articleFormat>${article.docTitle}</@articleFormat></h1>
