<#--
  ...
  $Id: article_crossref.ftl 13852 2013-03-01 03:11:34Z mbaehr $
...
<div id="pagebdy-wrap">
  ...
  <div class="clear"></div>
  <div id="pubGetError" style="display:none;"></div>
...
<script type="text/javascript">
  ...
  window.onload = function () {
    ...
    almService.setCrossRefText(doi, "crossRefLinks", "pubGetError", "almError", "loading");
  };
