...
/**
 * Implementation of {@link Cache} that keeps all elements in memory forever.
 * <p/>
 * THIS CLASS IS RECOMMENDED FOR USE IN TESTS AND PROTOTYPES ONLY!  It is not
 * appropriate for production use.
 */
public class EternalCache implements Cache {
