...
//    info:doi/10.1371/journal.pmed.0020073
  ...
  public Object[][] getArticlesWithEoc()
  {
    ...
    String eocTest = "<p><strong>Expression of Concern:</strong>Novel Allelic Variants in the Canine Cyclooxgenase-2 (Cox-2)" +
        " Promoter Are Associated with Renal Dysplasia in Dogs</p>\n" +
        "      \n" +
        ...
        "history of the manuscript, which revealed that due to a failure in the peer review process, several aspects of " +
        "the research were not adequately evaluated before publication.</p>\n" +
        "      <p>As a result, the <italic>PLOS ONE</italic> editors have undertaken a thorough re-examination of this " +
        "study, involving both external and internal advisers. This assessment has revealed the following concerns " +
        "regarding the study:</p>\n" +
        "      \n" +
        "        \n" +
        ...
        "association study based on Cox-2 or a genome-wide association study have been recommended as more appropriate " +
        "approaches to study this association.</p>\n" +
        "        </li>\n" +
        "        \n" +
        "          <p>The validity of the control population employed in the study is compromised as it involved " +
        "a different breed.</p>\n" +
        "        </li>\n" +
        "        \n" +
        "          <p>There are concerns about the strength of the evidence shown to support an association between the " +
        "Cox-2 variant and the dogs' phenotypes, as the evidence from other breeds suggests that this may be a neutral" +
        " DNA variant.</p>\n" +
        "        </li>\n" +
        "      \n" +
        "      <p>In the light of the concerns outlined above, the <italic>PLOS ONE</italic> editors are issuing this " +
        "Expression of Concern in order to make readers aware of the concerns about the reliability of the results and " +
        "conclusions reported in the article.</p>";
