...
import org.topazproject.ambra.model.article.Days;
import org.topazproject.ambra.model.article.Months;
import org.topazproject.ambra.model.article.Years;
import org.topazproject.ambra.search.SearchHit;
import org.topazproject.ambra.testutils.EmbeddedSolrServerFactory;
...
public class BrowseServiceSolrTest extends BaseTest {
  ...
  public void sendArticlesToSolr() throws Exception {
    if (!articlesHaveBeenSentToSolr) {
      ...
      document1.put("subject_level_1", new String[]{CATEGORY_1, CATEGORY_2});
      ...
      document2.put("subject_level_1", new String[]{CATEGORY_2});
  ...
  public void testGetArticleDates(String journalKey, Years expected) {
    Years years = browseService.getArticleDates(journalKey);
  ...
  public Object[][] getArticleCategoryCount() {
    ...
    counts.put(CATEGORY_1, 1L);
    counts.put(CATEGORY_2, 2L);
    return new Object[][]{
        {JOURNAL_KEY, counts}
    };
  }
  ...
  public void testGetArticleCountsByCategory(String journalKey, Map<String, Long> expectedCounts) {
    SortedMap<String, Long> results = browseService.getArticlesByCategory(journalKey);
  ...
  public Object[][] getArticlesForCategory() {
    return new Object[][]{
        {JOURNAL_KEY, CATEGORY_1, new String[]{DOI1}},
        {JOURNAL_KEY, CATEGORY_2, new String[] {DOI1, DOI2}}
    };
  }
  ...
  public void testGetArticlesByCategory(String journalKey, String category, String[] expectedIds) {
    List<SearchHit> results = browseService.getArticlesByCategory(
        category,  //category
        0,         //page number
        100,       //articles per page
        new long[]{0}, //num articles - just gets populated with the number of articles
        journalKey //journal
    );
    assertNotNull(results, "returned null results");
  ...
  public void testGetArticlesByDate(String journalKey, Calendar startDate, Calendar endDate, String[] expectedIds) {
    List<SearchHit> results = browseService.getArticlesByDate(
        startDate,   //start date
        endDate,     //end date
        null,        //article types - null for no filter
        0,           //page number
        100,         //articles per page
        new long[]{0},//num articles - just gets populated with the number of articles
        journalKey //journal
