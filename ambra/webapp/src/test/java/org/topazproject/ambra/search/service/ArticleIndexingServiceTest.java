...
public class ArticleIndexingServiceTest extends BaseTest {
  ...
  private static String badConfigFile = "org/topazproject/ambra/search/searchConfig-badValues.xml";
  ...
  public Object[][] getArticleData() {
    ...
    article1.setId(URI.create("info:doi/10.1371/journal.pgen.1000096"));
    article1.setState(Article.STATE_ACTIVE);
    dummyDataStore.store(article1);
    Article article2 = new Article();
    article2.setId(URI.create("info:doi/10.1371/journal.pgen.1000100"));
  ...
  public void testIndexArticle(Article article) throws Exception {
    articleIndexingService.indexArticle(article.getId().toString());
  }
