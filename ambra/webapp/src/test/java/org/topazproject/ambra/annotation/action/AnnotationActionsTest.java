...
//  private final String target = "doi:10.1371/annotation/21";
  ...
  private static final Logger log = LoggerFactory.getLogger(AnnotationActionsTest.class);
...
//  private String testXmlTarget = "file:webapp/src/test/resources/test.xml";
  ...
  protected void onSetUp() throws Exception {
    ...
    try {
      testXmlTarget = getArticlePersistenceService().ingest(new IngestionImpl(new URLDataSource(article), null), false).
                                             getId().toString();
...
//    final String target = getArticlePersistenceService().getObjectURL("info:doi/10.1371/journal.pone.0000008", "XML");
