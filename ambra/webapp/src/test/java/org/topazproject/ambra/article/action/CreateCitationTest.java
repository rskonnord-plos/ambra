...
public class CreateCitationTest {
  ...
  public void testExecute() throws Exception{
    ...
    ArticleOtmService articleOtmService = control.createMock(ArticleOtmService.class);
    action.setArticleOtmService(articleOtmService);
    ...
    expect(articleOtmService.getArticle(URI.create(articleUri)))
        .andReturn(article);
