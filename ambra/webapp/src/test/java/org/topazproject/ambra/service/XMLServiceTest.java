...
public class XMLServiceTest {
  ...
  public void testFullDOITransform(String source, String expected)
      throws URISyntaxException, ApplicationException, SAXException, IOException,
      ParserConfigurationException {
    ...
    diff = new Diff(getFileAsString(expected), sb.toString());
    ...
    diff = new Diff(new InputSource(new ByteArrayInputStream(bytesResult)),
