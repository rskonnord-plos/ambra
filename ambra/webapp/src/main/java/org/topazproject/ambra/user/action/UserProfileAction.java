...
public abstract class UserProfileAction extends UserActionSupport {
  ...
  static {
    ...
    fieldToUINameMapping.put(GIVEN_NAMES, "First Name");
    fieldToUINameMapping.put(SURNAMES, "Last Name");
    ...
    fieldToUINameMapping.put(POSITION_TYPE, "Your Role");
    fieldToUINameMapping.put(BIOGRAPHY_TEXT, "Short Biography");
    fieldToUINameMapping.put(RESEARCH_AREAS_TEXT, "Research Areas");
    fieldToUINameMapping.put(INTERESTS_TEXT, "Other Interests");
    fieldToUINameMapping.put(HOME_PAGE, "Website URL");
    fieldToUINameMapping.put(WEBLOG, "Blog URL");
  }
  ...
  private String orgVisibility = PRIVATE;
