 ...
 */
public class TopazReplyService extends BaseTopazAnnotationService implements ReplyService {
  private static final Logger log = LoggerFactory.getLogger(TopazReplyService.class);
