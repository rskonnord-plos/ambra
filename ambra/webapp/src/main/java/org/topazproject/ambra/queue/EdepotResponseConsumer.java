 ...
 */
public class EdepotResponseConsumer {

  private static final Logger log = LoggerFactory.getLogger(EdepotResponseConsumer.class);
   ...
   * @throws org.topazproject.ambra.ApplicationException If operation fails, URISyntaxException if
  ...
  public void handleResponse(@Body String body) throws Exception {
    ...
    if (body == null) {
      throw new ApplicationException("EDEPOT response message is null");
    }
    ...
    if (tokenizer.hasMoreTokens()) {
      ...
      throw new ApplicationException("Invalid Edepot response message received: " + body);
    }
