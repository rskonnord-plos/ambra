...
package org.topazproject.ambra.crossref;
...
public class CrossRefLookupServiceImpl implements CrossRefLookupService {
   ...
   * @see CrossRefArticle
   */
  public List<CrossRefArticle> findArticles(String title, String author) {
    ...
    try {
      ...
      log.error("Error running CrossRef search " + crossRefUrl, e);
    }
