 ...
 */
public class ArticleOtmService implements ArticlePersistenceService {
  private static final Logger log = LoggerFactory.getLogger(ArticleOtmService.class);
   ...
   * @throws org.topazproject.ambra.article.service.IngestException IngestException
   * @throws org.topazproject.ambra.article.service.DuplicateArticleIdException DuplicateArticleIdException
   ...
   * @return the contents
   * @throws org.topazproject.ambra.article.service.NoSuchObjectIdException if the object cannot be found
   */
  ...
  public List<String> getArticleIds(String startDate, String endDate, String[] categories,
    ...
    if (authors != null) {
      for(int a = 0; a < authors.length; a++) {
        authors[a] = RdfUtil.escapeLiteral(authors[a]);
      }
    }

    if (categories != null) {
      for(int a = 0; a < categories.length; a++) {
        categories[a] = RdfUtil.escapeLiteral(categories[a]);
      }
    }
   ...
   * @throws org.topazproject.ambra.article.service.NoSuchObjectIdException NoSuchObjectIdException
   */
  @Transactional(readOnly = true)
   ...
   * @throws org.topazproject.otm.OtmException when session.get fails.
   */
  @Transactional(readOnly = true)
   ...
   * @throws org.topazproject.ambra.ApplicationException if there was a problem talking to the OTM
   * @throws org.topazproject.ambra.article.service.NoSuchArticleIdException When the article does not exist
   */
   ...
   * @throws org.topazproject.otm.OtmException When there is an error talking to the OTM
   */
