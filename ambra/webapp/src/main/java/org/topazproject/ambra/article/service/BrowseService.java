...
public interface BrowseService {
   ...
   * @parem journalKey The current journal key
   * @return articles
   */
  public BrowseResult getArticlesByCategoryViaSolr(final String category, final int pageNum,
                                                   final int pageSize, final String journalKey);
