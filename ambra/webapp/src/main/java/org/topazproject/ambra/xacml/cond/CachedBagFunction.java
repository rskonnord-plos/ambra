...
public class CachedBagFunction implements Function {
  ...
  // shared logger
  private static final Logger log = LoggerFactory.getLogger(CachedBagFunction.class);
  ...
  protected EvaluationResult makeResult(Value value) {
    ...
    ArrayList<StringAttribute> bag = new ArrayList<StringAttribute>(results.length);

    for (String result : results)
      bag.add(new StringAttribute(result));
