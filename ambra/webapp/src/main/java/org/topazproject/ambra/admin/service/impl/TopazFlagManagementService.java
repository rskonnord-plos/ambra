 ...
 * @author alan
 */
public class TopazFlagManagementService implements FlagManagementService {
  private static final Logger log = LoggerFactory.getLogger(TopazFlagManagementService.class);
