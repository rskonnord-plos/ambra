 ...
 * <p/>
 * Annotating the action method with {@link org.topazproject.ambra.struts2.ManualTransactionManagement} will tell this
      ...
      public CallbackResult doInTransaction(TransactionStatus transactionStatus) {
        ...
        try {
          ...
          */
          ...
          if (transactionalAnnotation.noRollbackFor() != null) {
          ...
          if (!noRollback && transactionalAnnotation.rollbackFor() != null) {
