 ...
 */
public class TopazJournalService implements JournalService {
  private static final Logger    log = LoggerFactory.getLogger(TopazJournalService.class);
