        ...
        <ol>
          ...
          <li id="pubDateOptions" class="options" style="display:none;">
            <fieldset>
              ...
              <ol>
                <li>
                  <span class="hide">(Year)</span><input type="text" name="startDateAsString" size="10" maxlength="10" value="${startDateAsString!"YYYY-MM-DD"}" id="startDateId"/>
                  <label for="endDateId"> and </label>
                  <span class="hide">(Year)</span><input type="text" name="endDateAsString" size="10" maxlength="10" value="${endDateAsString!"YYYY-MM-DD"}" id="endDateId"/>
                </li>
              </ol>
            </fieldset>
          </li>
...
<#list journals as journal>
                <li><input id="limitToJournal_${journal.key}" name="limitToJournal" value="${freemarker_config.getIssn(journal.key)}" type="checkbox" <@chkdlist tstr=freemarker_config.getIssn(journal.key) strlist=(limitToJournal![])/>/>&nbsp;<label for="limitToJournal_${journal.key}">${freemarker_config.getDisplayName(journal.key)}</label></li>
</#list>
              </ul>
            </fieldset>
          </li>
