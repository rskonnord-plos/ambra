...
<html>
  ...
  <body>
    ...
    <#if autoIngestFiles?has_content>
      <fieldset>
        <legend><strong>Auto Ingesting Archives</strong><#if autoIngesting> ingest in progress....</#if></legend>
          <ul class="ingestible">
          <#list autoIngestFiles as file>
            <li>${file}</li>
          </#list>
          </ul>
      </fieldset>
      ...
      <fieldset>
        ...
        <@s.form id="processArticles" name="processArticles" action="processArticles" method="post" namespace="/admin">
          ...
          <table border="1" cellpadding="2" cellspacing="0">
            ...
            <#list orderedPublishableArticles as article>
              <#assign doi = article.getId().toString() >
              <tr id="tr_${doi?url}" >
                ...
                <td>
                  ${article.getDublinCore().getDate()?string("MM/dd/yyyy")} <br>
                </td>
                <td>
