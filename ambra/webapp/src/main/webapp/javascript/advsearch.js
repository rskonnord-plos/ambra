...
ambra.advsearch = {
  ...
  init: function() {
    ...
    if(document.selection) {
      // IE
      dojo.connect(dojo.byId(ambra.advsearch.Config.idJournalsAll), "onclick", ambra.advsearch.onChangeJournals);
      dojo.connect(dojo.byId(ambra.advsearch.Config.idJournalsSlct), "onclick", ambra.advsearch.onChangeJournals);
    } else {
      // gecko et al.
      dojo.connect(dojo.byId(ambra.advsearch.Config.idJournalsAll), "onchange", ambra.advsearch.onChangeJournals);
      dojo.connect(dojo.byId(ambra.advsearch.Config.idJournalsSlct), "onchange", ambra.advsearch.onChangeJournals);
    }
  ...
  tglJournals: function() {
    var rbAll = dojo.byId(ambra.advsearch.Config.idJournalsAll);
    var rbSlct = dojo.byId(ambra.advsearch.Config.idJournalsSlct);
    var enable = rbSlct.checked;
    var fs = dojo.byId(ambra.advsearch.Config.idFsJournalsOpt);
