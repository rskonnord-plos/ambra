  ...
  <div id="flagForm">
    ...
    <form name="discussionFlag" method="post" action="">
      ...
      <fieldset>
        ...
        <div class="btnwrap"><input name="submit" value="Submit" type="button" id="btnSubmit"
                                    title="Click to Submit Your Response"/></div>
        <div class="btnwrap"><input name="cancel" value="cancel" type="button" id="btnCancel"
                                    title="Click to close and cancel"/></div>
