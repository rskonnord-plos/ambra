  ...
  <div id="content" class="${styleCorrections}">
    ...
    <div class="response original">
      ...
      <blockquote>
        ...
        <#if baseAnnotation.citation??><div class="citation"><strong>Citation: </strong><#assign isCorrection = true/><#assign citation = baseAnnotation.citation/><#assign authorList = baseAnnotation.citation.annotationArticleAuthors/><#include "/article/citation.ftl"/></#if>
      </blockquote>
      <!-- end : response body text -->
      <!-- begin : toolbar options -->
      <div class="toolbar">
