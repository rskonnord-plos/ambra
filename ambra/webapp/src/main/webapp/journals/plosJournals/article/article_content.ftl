...
<div id="researchArticle" class="content">
  ...
  <#if journalContext = "PLoSMedicine" >
    <#include "/journals/medicine/article/article_blurb.ftl">
  <#elseif journalContext = "PLoSBiology" >
    <#include "/journals/biology/article/article_blurb.ftl">
  <#else>
