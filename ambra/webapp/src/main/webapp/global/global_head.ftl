...
<#if articleInfoX.authors??>
<#list articleInfoX.authors as author>
...
<@s.url id="pdfLink" namespace="/article" action="fetchObjectAttachment" includeParams="none" uri="${articleInfoX.id}" />
<meta name="citation_pdf_url"
      content="${Request[freemarker_config.journalContextAttributeKey].baseHostUrl}${pdfLink}&representation=PDF">
<meta name="citation_pdf_url" content="${Request[freemarker_config.journalContextAttributeKey].baseHostUrl}${pdfLink}&representation=PDF">

<#if articleInfo??>
<meta name="citation_journal_title" content="${publishedJournal}">
<meta name="citation_firstpage" content="${articleInfo.dublinCore.bibliographicCitation.ELocationId}"/>
<meta name="citation_issue" content="${articleInfo.dublinCore.bibliographicCitation.issue}"/>
<meta name="citation_volume" content="${articleInfo.dublinCore.bibliographicCitation.volume}"/>
<meta name="citation_issn" content="${articleInfo.eIssn}"/>
</#if>
</#if>
