...
public class FSIDMapper {
  ...
  private static Pattern p1 = Pattern.compile("(info:doi)/([0-9\\.]+)/journal\\.([a-z]+)\\.([0-9]+)([\\.a-z0-9]*)");
  private static Pattern p2 = Pattern.compile("(info%3Adoi)%2F([0-9\\.]+)%2Fjournal\\.([a-z]+)\\.([0-9]+)([\\.a-z0-9]*)");
  private static Pattern p3 = Pattern.compile("(info:doi)/([0-9\\.]+)/(image\\.[a-z]+\\.v[0-9]+\\.i[0-9]+)([\\.a-z0-9]*)");
  private static Pattern p4 = Pattern.compile("(info:doi)/([0-9\\.]+)/journal\\.(image\\.[a-z]+\\.v[0-9]+\\.i[0-9]+)([\\.a-z0-9]*)");
