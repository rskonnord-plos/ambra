...
<div id="content" class="static">
  ...
  <p>
    The Overlay Journal allows users to rate articles for subjective "quality". Scientific work can be measured on a number of scales. To reflect this, research articles can be rated in three separate categories: Insight, Reliability, and Style. Rating is done on a 1 to 5 scale with 1 being the lowest and 5 the highest rating.
  </p>
